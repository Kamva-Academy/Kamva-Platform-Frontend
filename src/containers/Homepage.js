            ...
            <Grid container item direciton="column" xs={12} sm={6} spacing={2}>
              <Grid item xs={12}>
                <Typography
                  ...
                  امروزه مدل‌سازی ریاضی به عنوان ابزاری قوی در رشته‌های مختلف
                  مورد استفاده قرار می‌گیرد. به همین منظور آموزش این شاخه از
                  ریاضیات به دانش‌آموزان در دستور کار بسیاری از نظام‌های آموزشی
                  قرار گرفته است. هرساله چندین مسابقه مدل‌سازی ریاضی در سراسر
                  دنیا برای گروه‌های سنی مختلف برگزار می‌شود. یکی از این
                  مسابقات، A-لیمپیاد است که با هدف افزایش قدرت تفکر، یادگیری
                  تکنیک‌های مدل‌سازی ریاضی، کارگروهی، تمرین نوشتن یافته‌های علمی
                  و جمع‌بندی و ارائه مطالب، در هلند و تعدادی دیگر از کشورها
                  برگزار می‌شود.
                </Typography>
              </Grid>
              <Grid item xs={12}>
