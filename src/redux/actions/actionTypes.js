...
export const INIT_CURRENT_WORKSHOP = 'INIT_CURRENT_WORKSHOP';

export const GET_CURRENT_WORKSHOP_REQUEST = 'GET_CURRENT_WORKSHOP_REQUEST';
export const GET_CURRENT_WORKSHOP_SUCCESS = 'GET_CURRENT_WORKSHOP_SUCCESS';
export const GET_CURRENT_WORKSHOP_FAILURE = 'GET_CURRENT_WORKSHOP_FAILURE';
