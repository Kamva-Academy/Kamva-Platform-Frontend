...
export const SUBMIT_ANSWER = ROOT.concat('fsm/submitanswer/')
...
export const WORKSHOP_TEAMS = ROOT.concat('fsm/teams/')
export const TEAM_ANSWERS = ROOT.concat('fsm/submittedanswers/')
export const VISIT_TEAM = ROOT.concat('fsm/gototeam/')